...
namespace Projectiles.UI
{
    public class UIScreenEffects : UIBehaviour
    {
        ...
        [SerializeField] private UIBehaviour _deathGroup;
        [SerializeField] private CanvasGroup _pauseGroup;

        [Header("Animation")]
        [SerializeField] private float _hitFadeInDuration = 0.1f;
        [SerializeField] private float _hitFadeOutDuration = 0.7f;

        [Header("Audio")]
        [SerializeField] private AudioSetup _hitSound;
        [SerializeField] private AudioSetup _deathSound;
        ...
        {
            SetPanelVisualization(_pauseGroup, 50, pause);
        }
        ...
        private void SetPanelVisualization(CanvasGroup group, float targetAlpha, bool pause)
        {
            DOTween.Kill(group);
            ...
            {
                group.DOFade(0f, _hitFadeOutDuration);
            }
        }
    }
}
